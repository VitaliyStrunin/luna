from src.payments.infrastructure.database.repositories.interfaces.outbox import IOutboxRepository
from sqlalchemy.ext.asyncio import AsyncSession
from sqlalchemy import select
from src.payments.domain.entities.outbox import PaymentOutbox, PaymentOutboxCreate
...
class OutboxRepositoryPostgres(IOutboxRepository):
    ...
    async def mark_as_sent(self, event: PaymentOutbox):
        event.sent = True